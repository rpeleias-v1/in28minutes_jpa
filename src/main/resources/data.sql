...
insert into course(id, name, created_date, last_updated_date,is_deleted) values (10003, 'Spring Boot in 50 steps', sysdate(), sysdate(), false);

insert into passport(id,number) values(40001, 'E123456');
insert into passport(id,number) values(40002, 'N789601');
insert into passport(id,number) values(40003, 'J234454');
...
insert into review(id,rating, description, course_id) values(50002, '4', 'Wonderful Course', 10003);
insert into review(id,rating, description, course_id) values(50003, '5', 'Great Course', 10001);
